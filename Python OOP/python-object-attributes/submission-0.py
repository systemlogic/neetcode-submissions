...
print("Initial Attributes: Whiskers ({}) - Hunger: {}, Energy: {}".format(whiskers.species, whiskers.hunger, whiskers.energy))
...
print("Modified Attributes: Whiskers ({}) - Hunger: {}, Energy: {}".format(whiskers.species, whiskers.hunger, whiskers.energy))